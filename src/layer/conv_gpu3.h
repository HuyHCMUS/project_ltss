#ifndef SRC_LAYER_CONVGPU3_H_
#define SRC_LAYER_CONVGPU3_H_

#include <vector>
#include "../layer.h"
#include "conv_utils.h"

class ConvGPU3: public Layer {
 private:
  const int dim_in;
  int dim_out;
 ...
 public:
  ConvGPU3(int channel_in, int height_in, int width_in, int channel_out,
